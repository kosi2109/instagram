  ...
  return (
    <>
      <nav
        ...
        style={{ zIndex: "100" }}
      >
        <div className="w-2/4 sm:w-1/3 md:w-2/5 mr-5 h-full flex justify-start items-center">
          <NavLink to="/">
            <img src={logo} alt="logo" className="w-full h-full" />
          </NavLink>
        </div>

        <div className="hidden sm:flex relative h-full justify-center items-center sm:w-1/3 md:3/5">
          <input
            type="text"
        ...
        <div className="w-2/5 justify-between items-center hidden md:flex md:px-5">
          <NavBtn size="25" setOpenCreateModal={setOpenCreateModal} />
        </div>
        <div className="w-3/4 sm:w-1/3 flex justify-between items-center md:hidden">
