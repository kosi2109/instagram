    ...
    <div className="flex flex-col justify-start items-center mt-8">
      <div className="pt-8 bg-secondary px-16 w-350 flex flex-col justify-start items-center mb-5 rounded border-2 border-borderPrimary">
        ...
        >
          ...
          <button
            className="mb-3 bg-btnPrimary text-secondary rounded-sm w-full h-8"
            type="submit"
          >
            Login
          </button>
        ...
        <div className="w-full py-3">
          ...
          {error && (
            <div className="w-full text-center text-danger my-4 p-2">
              <p>{error}</p>
            </div>
          )}
          <div className="text-center">
            <Link
              ...
              className="text-center text-sm text-btnPrimary"
            >
              Forgot Password ?
            </Link>
          </div>
      ...
      <div className="bg-secondary w-350 py-4 rounded border-2 border-borderPrimary">
        <h5 className="text-center">
          ...
          <Link to="/accounts/emailsignup">
            <span className="text-btnPrimary font-bold">Sign Up</span>
          </Link>
        </h5>
      </div>
    </div>
