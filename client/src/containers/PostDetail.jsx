...
import { commentPost, deleteComment, getPost, likePost } from "../actions/post";
...
function PostDetail({ width = "full" }) {
  ...
  const deleteCommentControl = (e,id)=>{
    e.preventDefault();

    dispatch(deleteComment({comment_id:id,post_id:post._id}))
  }
          ...
          {post?.comment.map((com, index) => (
            <div className="flex w-full flex-col">
              ...
              <div className="ml-16 flex">
                ...
                <form onSubmit={(e)=> deleteCommentControl(e,com?._id)}>
